                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light">
                                    ...
                                    <i class="fa fa-angle-double-left"
                                       onclick="javascript:window.location.href='/message/read?status=${status},page=1&siez=20';">
                                    </i>
                                </button>
                                <button type="button" class="btn btn-default light">
                                    <%-- 上一页 --%>
                                    <i class="fa fa-chevron-left"
                                       onclick="javascript:window.location.href='/message/read?status=${status},page=${ps.pageNum -1}&siez=20';">
                                    </i>
                                </button>
                                ...
                                <button type="button" class="btn btn-default light">
                                    ...
                                    <i class="fa fa-angle-double-right"
                                       onclick="javascript:window.location.href='/message/read?status=${status},page=${ps.pages}&siez=20';">
                                    </i>
                                </button>
                            </div>
                        </div>
